...
@section('content')
    ...
    <body class="bg-white font-poppins">
        ...
        <div
            ...
            <h1 class="text-blue-800 roboto font-bold text-2xl mb-3">
                Reservasi Venue Online Terbaik
            </h1>
            <a href="/create" class="bg-blue-800 px-4 py-2 rounded-lg text-white hover:bg-blue-600 transition duration-100 ease-in-out">
                Daftarkan Venue ->></a>
        </div>
