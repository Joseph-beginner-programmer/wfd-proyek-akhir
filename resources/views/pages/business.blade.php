            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                <div class="w-full">
                    <img src="https://images.unsplash.com/photo-1443527394413-4b820fd08dde?q=80&w=1169&auto=format&fit=full"
                        alt="Gedung Pencakar Langit" class="w-full h-full object-cover rounded-lg shadow-lg">
                </div>

                <div class="text-gray-700">
                    <h3 class="text-3xl font-bold text-gray-900 mb-4">Memodernisasi Pemesanan Venue</h3>
                    <p class="mb-6">
                        Di era digital ini, kami melihat adanya kebutuhan krusial untuk sistem yang efisien dan terintegrasi
                        dalam berbagai sektor. ReserveIn lahir dari gagasan untuk mentransformasi proses pemesanan venue
                        yang seringkali masih manual, memakan waktu, dan rentan terhadap kesalahan.
                    </p>

                    <div class="mb-6">
                        <h4 class="text-2xl font-semibold text-blue-800 mb-2">Visi Kami</h4>
                        <p>Menjadi platform pemesanan venue terdepan yang paling terpercaya dan mudah digunakan di seluruh
                            Indonesia, memberdayakan baik penyewa maupun pemilik venue.</p>
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <ul class="list-disc list-inside space-y-2">
                            ...
                            <li>Memberikan fitur laporan yang komprehensif bagi pemilik venue untuk mengoptimalkan bisnis
                                mereka.</li>
                    ...
                    <div>
                        ...
                        <ul class="list-disc list-inside space-y-2">
                            <li><strong>Pencarian Cerdas:</strong> Filter berdasarkan harga, lokasi, kapasitas, dan
                                fasilitas.</li>
                            <li><strong>Manajemen Mudah:</strong> Dasbor intuitif untuk pemilik venue mengelola jadwal dan
                                pesanan.</li>
                            <li><strong>Laporan Analitis:</strong> Data harian, mingguan, hingga tahunan untuk pengambilan
                                keputusan.</li>
                        </ul>
                    </div>
                </div>
