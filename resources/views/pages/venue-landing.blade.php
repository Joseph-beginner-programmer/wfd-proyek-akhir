<div x-data="{ activeTab: 'pemilik' }" class="max-w-3xl md:max-w-4xl lg:max-w-xl mx-auto p-4">
    <div class="flex border-b border-gray-200 mt-20">
        ...
        <button @click="activeTab = 'penyewa'"
            :class="{
    ...
    <div class="mt-4">
        <div x-show="activeTab === 'pemilik'" x-transition>
            <div class="p-6 bg-white rounded-lg shadow">
                ...
                <p class="text-xl monteserrat-body text-justify">Waktunya buat venue anda lebih dari sekadar venue.
                    Semuanya dimulai dengan pengelolaan yang simpel, fleksibel, dan profitable lewat ReserveIn Venue
                    Management.</p>
        ...
        <div x-show="activeTab === 'penyewa'" x-transition x-cloak>
            <div class="p-6 bg-white rounded-lg shadow">
                ...
                <p class="text-xl monteserrat-body text-justify">Butuh venue untuk pernikahan? olahraga? acara keluarga?
                    gunakan ReserveIn untuk menemukan venue yang paling cocok untuk Anda!</p>
                <p class="mt-5 underline text-blue-600 monteserrat-body hover:text-blue-800">Lihat selengkapnya -></p>
            </div>
        </div>
    </div>
