                            ...
                            @forelse ($booking->bookingHours as $bookedHour)
                                @if ($bookedHour->jadwalVenue)
                                    <li class="flex items-center bg-gray-50 p-3 rounded-md">
                                        ...
                                        <span>
                                            Jam {{ \Carbon\Carbon::parse($bookedHour->jadwalVenue->start_time)->format('H:i') }}
                                            - {{ \Carbon\Carbon::parse($bookedHour->jadwalVenue->end_time)->format('H:i') }}
                                        </span>
                                    </li>
                                @endif
                            @empty
                                <li class="text-gray-500">
                                    Rincian jam tidak tersedia untuk booking ini.
                                </li>
                            @endforelse
                        </ul>
                    </div>
