    ...
    <div class="container mx-auto p-4 md:p-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 lg:gap-8">
            ...
            <div class="lg:col-span-1 space-y-6 mt-8 lg:mt-0">
                ...
                <a href="{{ route('payment.method', ['id' => $booking->booking_id]) }}" class="w-full bg-blue-700 text-white font-bold py-3 px-4 rounded-lg hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition">
