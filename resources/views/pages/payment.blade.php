    ...
    <div class="container mx-auto p-4 md:p-8">
        <div class="grid grid-cols-1 lg:grid-cols-3 lg:gap-8">
            <div class="lg:col-span-2 space-y-6">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-gray-800">Suryabaja Badminton Hall Surabaya</h1>
                ...
                <div class="bg-white rounded-xl shadow-md p-6">
                    <h2 class="text-lg font-bold text-gray-800 mb-4">Lapangan A</h2>
                    <div class="space-y-4">
                        
                        <div class="flex justify-between items-center">
                            <div>
                                <p class="text-gray-800 font-medium">Jum, 20 Juni 2025 • 11:00 - 12:00</p>
                                <p class="text-gray-600 font-semibold">Rp50.000</p>
                            </div>
                        ...
                        <div class="flex justify-between items-center">
                            <div>
                                <p class="text-gray-800 font-medium">Jum, 20 Juni 2025 • 12:00 - 13:00</p>
                                <p class="text-gray-600 font-semibold">Rp50.000</p>
                            </div>
                            <button class="text-gray-400 hover:text-blue-500">
                                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
